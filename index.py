...
if question == "/name":
    ...
    print("I am not positive exactly what I want to do with my degree, but I would like a job that has some sort of graphic element as I enjoy the visual aspect of coding as well as the background programs.")
elif question == "/fact":
